                        ...
                        <div class="col-md-6 col-md-offset-3">
                            <div class="footer-content text-center padding-ver-clear">
                                ...
                                <ul class="list-inline mb-20">
                                    ...
                                    <li><a href="mailto:info@theproject.com" class="link-dark"><i class="text-default fa fa-envelope-o pl-10 pr-5"></i>contato@plantasbrasil.com</a></li>
                                </ul>
                                ...
                                <p class="text-center margin-clear">Copyright © <?=date('Y')?> Plantas do Brasil por <a target="_blank" href="http://gweb.com.br/">GWeb</a>. Todos os direitos reservados.</p>
                            </div>
                        </div>
                    </div>
                </div>
