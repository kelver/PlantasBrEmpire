...
class CreateCadastro extends AbstractMigration
{
    public function up(){
        $this->table('cadastro')
            ...
            ->addColumn('primeiro_acesso', 'datetime', array('default' => 'CURRENT_TIMESTAMP', 'update' => 'CURRENT_TIMESTAMP', 'null' => true))
            ->addColumn('ultimo_acesso', 'datetime',  array('default' => 'CURRENT_TIMESTAMP', 'null' => true))
            ->addColumn('status', 'integer', array('default' => '1'))//1:ativo 0:inativo
            ->addColumn('idPessoa', 'integer')
            ->addColumn('dataAssinatura', 'datetime',  array('default' => 'CURRENT_TIMESTAMP', 'null' => true))
