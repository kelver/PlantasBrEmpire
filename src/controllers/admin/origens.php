...
$app
    ...
    ->get('/admin/Origens/{id}/edit', function(ServerRequestInterface $request) use ($app){
        $view = $app->service('view.renderer');
        ...
        return $view->render('/admin/Origens/edit.html.twig', [
            'origens' => $origens
        ]);
    }, 'admin.origens.edit')
    ->post(
