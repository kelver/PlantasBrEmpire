...
$app
    ...
    ->get('/admin/Referencias/{id}/edit', function(ServerRequestInterface $request) use ($app){
        $view = $app->service('view.renderer');
        ...
        return $view->render('/admin/Referencias/edit.html.twig', [
            'referencias' => $referencias
        ]);
